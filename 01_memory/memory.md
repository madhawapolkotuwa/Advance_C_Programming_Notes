...
3. Value `42` is stored at that address
...
![stack vs heap](stack_vs_heap_01.png)  
![stack vs heap](stack_vs_heap_02.png)
...
```c
int *p = malloc(sizeof(int)); // This allocates memory somewhere in heap.
...
<details>
  <summary style="color:#93f022">Click to reveal the answer to the question</summary>
