...
Because we go to address `0x1000` and overwrite it.
...
<details>
  <summary style="color:#93f022">Click to reveal the answer to the questions</summary>
...
## 🚨 Now Move to Something Powerful
...
5. Draw the memory lawet in the head.
